  ...
  return (
    <SystemContextProvider>
      <SystemModalContextProvider>
        <FocusAppsContextProvider ids={["rpgscript", "rpgscriptspecs", "portfolio", "linkedin", "termsofservice", "privacypolicy", "background", "navbar"]}>
          <FocusWindowsContextProvider ids={["rpgscript", "rpgscriptspecs", "termsofservice", "privacypolicy", "background", "navbar", "startupmenu"]}>
